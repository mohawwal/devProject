      ...
      <div className="border-[#aaa] border-b-[1px] flex gap-4 flex-col justify-center items-center px-4 relative z-10">
        ...
        <div className="max-w-3xl pt-3 pb-6 text-start font-normal text-[#777] text-sm leading-relaxed space-y-3">
          <p>
            ...
            , I started questioning what life after school would look like.
            While juggling exams and research, I explored other interests, from
            art to YouTube and content creation.
          </p>
          <p>
            One day, I accidentally clicked on a{" "}
            <span className="text-[#aaa]">JavaScript tutorial</span> video on youtube
            while searching for how to "making better YT content". I got
            curious & kept watching & that curiosity quickly turned into passion. I taught myself HTML, CSS, &
            JavaScript, and once I found React, I was all in.
          </p>
          <p>
            I began a <span className="text-[#aaa]">100 Days of Code</span>{" "}
            challenge on Twitter. Right before exams, someone asked me to build
            an NFT website. I took it on, built it with React, and delivered my
            best.
          </p>
          <p>
            ...
            , and my first real gig. That’s when I knew this is what I want to
            do.
          </p>
          <p>
          ...
          <p>
            <span className="text-[#aaa]">This portfolio?</span> I built it
            fullstack with an admin dashboard to upload projects and track
            visits by country.
          </p>
          <p>
            <span className="text-[#aaa]">I'm open to new opportunities</span>{" "}
            and always learning one line of code at a time.
          </p>
        </div>
      </div>
    </div>
